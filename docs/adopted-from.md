...
|-----------|----------------------|-----------------|------|
| toolbatch (partition by concurrency safety + read-only shell checker) | `packages/core/src/core/coreToolScheduler.ts:1284-1348`, `packages/core/src/utils/shellReadOnlyChecker.ts` | pending | pending |
| outputclamp (window-clamped `max_tokens`) | `packages/core/src/core/tokenLimits.ts:36-77` | pending | pending |
| microcompact (rule-based blanking of old tool results) | `packages/core/src/services/microcompaction/microcompact.ts:14,40-64`, `packages/core/src/services/chatCompressionService.ts:109-124` | pending | pending |
| truncation (head+tail with spill-to-disk) | `packages/core/src/tools/truncation.ts:22,200-296`, `packages/core/src/tools/shell.ts:91-112` | pending | pending |
| search_tools (`grep_search` + glob) | `packages/core/src/tools/ripGrep.ts`, `packages/core/src/tools/grep.ts`, `packages/core/src/tools/glob.ts` | pending | pending |
| editmatch (tolerant edit match + prior-read enforcement) | `packages/core/src/utils/editHelper.ts:313-380`, `packages/core/src/tools/priorReadEnforcement.ts` | pending | pending |
| stream guards (idle + lifetime watchdog) | `packages/core/src/core/openaiContentGenerator/constants.ts:1-68`, `packages/core/src/core/openaiContentGenerator/pipeline.ts:412-530` | pending | pending |
| prompttext (base system prompt structure) | `packages/core/src/core/prompts.ts:278-440` | pending | pending |
| loop guards (repeated/excess tool-call halting) | `packages/core/src/services/loopDetectionService.ts:35,140` | pending | pending |
| token estimation (chars/4 fallback, no per-turn count API) | `packages/core/src/services/tokenEstimation.ts` | pending | pending |
