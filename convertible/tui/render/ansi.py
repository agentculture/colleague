"""Stdlib-only ANSI renderer for the convertible TUI cockpit.
...
from convertible.tui.widgets.skill_panel import render_skill_panel
from convertible.tui.widgets.status_bar import render_status_bar
