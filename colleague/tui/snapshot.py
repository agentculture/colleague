...
from colleague.tui.events import dumps_events, loads_events
...
class Snapshot:
    ...
    events:
        ...
        :func:`~colleague.tui.events.loads_events`.
    markdown:
        The Markdown render string — the output of
        :func:`~colleague.tui.render.markdown.render_markdown`. Defaults
...
def write_snapshot(
    ...
    name:
        ...
        separators.
    state:
        The :class:`~colleague.tui.state.CockpitState` snapshot to capture.
    events:
