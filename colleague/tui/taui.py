"""Colleague TUI — TAUI semantic mirror.
...
consume it without any ``colleague`` import.
...
Usage::
    ...
    from colleague.tui.taui import serialize, SCHEMA_VERSION
...
def serialize(state: "CockpitState") -> dict[str, Any]:
    ...
    ----------
    state:
        The canonical :class:`~colleague.tui.state.CockpitState` snapshot.
