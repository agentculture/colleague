"""Colleague TUI — dotted-path selector resolution over the TAUI mirror.
...
- :func:`selector_to_event` — map an action selector to a :class:`~colleague.tui.events.Event`.
"""
...
from colleague.tui.events import Dismiss, Event
...
def selector_to_event(taui: dict[str, Any], selector: str) -> Event:
    """Map a popup-action *selector* to an :class:`~colleague.tui.events.Event`.
